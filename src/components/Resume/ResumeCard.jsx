const ResumeCard = ({ title, subTitle, des, result }) => {
  return (
    <div className="flex w-full h-1/3 group">
      ...
      <div className="w-full dark:bg-gray bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg p-4 lgl:px-10 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowTwo dark:shadow-shadowOne">
